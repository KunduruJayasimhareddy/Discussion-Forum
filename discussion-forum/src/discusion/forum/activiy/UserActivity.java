...
public class UserActivity {
	...
	public void deleteQuestion(UserActivity userActivity, User user) throws NumberFormatException, IOException {
		...
		else if(user.getUserRole()==UserRole.MODERATOR)//checks the user is moderator or not
		{
			if(question.getUser().getUsername().equals(user.getUsername())||question.getUser().getUserRole()==UserRole.USER){
